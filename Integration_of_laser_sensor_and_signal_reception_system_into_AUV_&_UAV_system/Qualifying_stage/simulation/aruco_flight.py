...
if __name__ == "__main__":
    camera_matrix, dist_coeffs = load_coefficients("/home/arrma/PROGRAMMS/Arhipelag_2026/Integration_of_laser_sensor_and_signal_reception_system_into_AUV_&_UAV_system/optimized_camera_params.yml")
    ...
    camera = Camera()
    mini = Pioneer(name="pioneer", ip="127.0.0.1", mavlink_port=8000, connection_method="udpout",
